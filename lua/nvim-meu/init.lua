  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
...

      {
        ...
        build = fzf_build_cmd, -- "cmake -S. -Bbuild -DCMAKE_BUILD_TYPE=Release && cmake --build build --config Release && cmake --install build --prefix build",
      },
...
vim.keymap.set("n", "<leader>e", "Neotree float toggle", { desc = "Neotree" })

-- The line beneath this is called `modeline`. See `:help modeline`
-- vim: ts=2 sts=2 sw=2 et

require "nvim-meu.options"
require "nvim-meu.keymaps"
